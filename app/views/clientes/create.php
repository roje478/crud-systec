                    ...
                    <div class="form-intro">
                        <div class="form-intro__wrapper">
                            ...
                            <div class="form-intro__content">
                                <h3 class="form-intro__title">Datos del Cliente</h3>
                                <p class="form-intro__description">Complete la información requerida para crear un nuevo cliente</p>
                            </div>
                            ...
                            <div class="form-intro__actions">
                                ...
                                <button type="submit" class="btn btn--primary" id="submitBtn" form="createClienteForm">
                                    <i class="fas fa-save btn__icon"></i>Crear Cliente
                                </button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="service-info__field">
                            ...
                            <div class="service-info__input">
                                ...
                                <input type="tel" class="form__control" id="telefono"
                                    name="telefono" placeholder="Ej: 3001234567">
                            </div>
                        </div>
        ...
        fetch('<?= url('clientes/store') ?>', {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    showErrorMessage(data.message || 'Error al crear el cliente');
                }
            })
            .catch(error => {
                console.error('Error:', error);
                showErrorMessage('Error de conexión al crear el cliente');
            })
            .finally(() => {
                // Restaurar botón
