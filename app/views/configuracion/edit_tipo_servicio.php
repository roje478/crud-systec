            ...
            <div class="service-info-card service-info-card--info">
                <div class="service-info-card__header">
                    <h5 class="service-info-card__title">
                        <i class="fas fa-info-circle"></i> Información del Tipo de Servicio
                    </h5>
                </div>
                <div class="service-info-card__body">
                    <div class="tech-info-compact">
                        <div class="tech-info__row">
                            <div class="tech-info__label">
                                <i class="fas fa-hashtag"></i> ID del Tipo
                            </div>
                        ...
                        <div class="tech-info__row">
                            ...
                            <div class="tech-info__value">
                                <?= date('d/m/Y H:i', strtotime($tipo['created_at'] ?? 'now')) ?>
                            </div>
                        </div>
                        ...
                        <div class="tech-info__row">
                            ...
                            <div class="tech-info__value">
                                <?= date('d/m/Y H:i', strtotime($tipo['updated_at'] ?? 'now')) ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="alert alert--warning">
                        ...
                        <p class="mb-0">
                            Los cambios en el tipo de servicio afectarán a todos los servicios que lo utilicen.
                    ...
                    <div class="alert alert--success">
                        ...
                        <p class="mb-0">
                            Una vez actualizado el tipo de servicio:
                        </p>
                        <ul class="mb-0">
                    ...
                    <div class="alert alert--info">
                        <h6 class="alert__heading">
                            <i class="fas fa-tools"></i> Tipos Comunes
                        </h6>
                        <ul class="mb-0">
