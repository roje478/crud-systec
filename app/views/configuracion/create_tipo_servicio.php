                    ...
                    <div class="form-intro">
                        <div class="form-intro__wrapper">
                            ...
                            <div class="form-intro__content">
                                <h3 class="form-intro__title">Crear Nuevo Tipo de Servicio</h3>
                                <p class="form-intro__description">Agrega un nuevo tipo de servicio al sistema</p>
                            </div>
                            ...
                            <div class="form-intro__actions">
                                ...
                                <button type="submit" class="btn btn--primary" id="submitBtn" form="createTipoServicioForm">
                                    <i class="fas fa-save btn__icon"></i>Crear Tipo de Servicio
                                </button>
                            </div>
                        </div>
                    </div>

                    <form id="createTipoServicioForm" class="service-info-grid">
                ...
                <div class="service-info-card__body">
                    <div class="alert alert--info">
                        <h6 class="alert__heading">
                            <i class="fas fa-lightbulb"></i> Ejemplos de Tipos de Servicio Comunes
                        </h6>
                        <div class="row">
                            <div class="col-md-6">
                                <ul class="mb-0">
                    ...
                    <div class="alert alert--success">
                        ...
                        <p class="mb-0">
                            Una vez creado el tipo de servicio, podrás:
                        </p>
                        <ul class="mb-0">
                            <li>Asignarlo a los servicios</li>
                            <li>Editarlo desde la lista de tipos</li>
                            <li>Usarlo en el flujo de trabajo</li>
                            <li>Generar reportes por tipo</li>
                        </ul>
                    </div>

                    <div class="alert alert--info">
                        <h6 class="alert__heading">
                            <i class="fas fa-tools"></i> Consejos
                        </h6>
                        <ul class="mb-0">
                            <li>Usa nombres descriptivos y específicos</li>
                            <li>Considera las categorías más comunes</li>
                            <li>Mantén consistencia en la nomenclatura</li>
                            <li>Evita duplicados o nombres muy similares</li>
                        </ul>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function checkFormChanges() {
        const form = document.getElementById('createTipoServicioForm');
    ...
    function resetForm() {
        if (confirm('¿Está seguro de que desea limpiar todos los campos?')) {
            document.getElementById('createTipoServicioForm').reset();
            originalFormData = {};
            formChanged = false;
            updateDiscardButton();
        }
    ...
    document.getElementById('createTipoServicioForm').addEventListener('submit', function(e) {
        e.preventDefault();
        ...
        // Enviar datos
        fetch('<?= url('configuracion/create-tipo-servicio') ?>', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            if (data.success) {
                showSuccessMessage(data.message || 'Tipo de servicio creado exitosamente');
                ...
                showErrorMessage(data.message || 'Error al crear el tipo de servicio');
            }
        })
        .catch(error => {
            console.error('Error:', error);
            showErrorMessage('Error de conexión al crear el tipo de servicio');
        })
        .finally(() => {
            // Restaurar botón
