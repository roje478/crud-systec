...
<div class="table-container">
    <table class="table table-striped table-hover" id="serviciosCompletosTable">
...
<!-- Información de la lista completa -->
<div class="alert alert-info mt-4">
    <div class="d-flex align-items-center">
        <i class="fas fa-info-circle me-3 fa-2x"></i>
        <div>
            <h6 class="alert-heading mb-1">Lista Completa de Servicios</h6>
            <p class="mb-0">Mostrando todos los <?= $totalServicios ?> servicios del sistema con paginación de 20 por página. Usa la búsqueda y ordenamiento para encontrar servicios específicos.</p>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    $('#serviciosCompletosTable').DataTable({
        ...
        // Configuración de paginación - 20 servicios por página
        pageLength: 20,
